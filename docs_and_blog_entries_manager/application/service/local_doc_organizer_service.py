...
class LocalDocOrganizerService:
    ...
    def __init__(self, category_tree_def: CategoryTreeDefinition, document_file_mover: DocumentFileMover,
                 doc_entry_restorer: DocEntryRestorer, stored_doc_entries_accessor: StoredDocEntriesAccessor):
