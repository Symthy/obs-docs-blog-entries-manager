...
class BlogEntryPusherService:
    ...
    def execute(self, doc_id: DocEntryId):
        ...
        self.__insert_blog_category_to_doc(doc_dateset.doc_entry)
    ...
    def __insert_blog_category_to_doc(self, doc_entry: DocEntry):
        self.__document_file_accessor.insert_category_path_to_content(doc_entry.doc_file_path, BLOG_CATEGORY)
        self.__stored_doc_entries_accessor.save_entry(doc_entry.update_category(BLOG_CATEGORY))
