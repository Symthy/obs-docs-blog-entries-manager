...
class LocalDocPusherService:
    ...
    def push_all(self, work_doc_file_paths: str):
        for work_doc_file_path in work_doc_file_paths:
            self.push(work_doc_file_path)

    def push(self, work_doc_file_path) -> DocEntryId:
